...
export class SaisieComponent implements OnInit {
  ...
  cols = [
    ...
    { field: "mv_libop", header: "Libelle",  width: "39%", display: "table-cell",  align: "left", size: "0.8em" },
    ...
    { field: "mv_folio", header: "Action",  width: "6%", display: "table-cell",  align: "center", size: "0.8em" },
