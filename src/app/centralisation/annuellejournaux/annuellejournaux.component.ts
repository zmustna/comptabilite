...
@Component({
  selector: 'app-annuellejournaux',
  templateUrl: './annuellejournaux.component.html',
  styleUrls: ['./annuellejournaux.component.css']
})
export class AnnuellejournauxComponent implements OnInit {
...
onReset(){
  ...
  selectrow(e) {
   ...
   res.push('idjl');  res.push(e.data.jl_code);
    ...
    this.Spinner.show(); this.resultt = [];
      this.service.getList("/fmvt/Getannuelledet", this.resultx)
    .subscribe(
      (data:any) => {
        this.resultt = [];
        this.resultt=data;
  ...
  getjournal(){
    ...
    this.resultx = []; this.resultx = res;
    this.Spinner.show(); this.result = [];
      this.service.getList("/fmvt/Getannuel", this.resultx)
    .subscribe(
      (data:any) => {
        this.result = [];
        this.result=data;
