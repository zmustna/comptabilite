...
@Component({
  selector: 'app-userandmenu',
  templateUrl: './userandmenu.component.html',
  styleUrls: ['./userandmenu.component.scss']
})
export class UserandmenuComponent implements OnInit {
  ...
  getcompanyUserglobal(){
    let res = new Array<any>(); res.push('CompanyUserId'); res.push(this.standarCompany);
  ...
  selectrow(e) {
     ...
     this.getcompanyUserglobal(); this.getcompanyUser();
  }
  selectrowchoose(e) {
